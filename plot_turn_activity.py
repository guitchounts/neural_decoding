...
def plot(y_left,y_right,X_left,X_right,head_name,file_name,tet_num=0,plot_single_tet=0):
    ...
    if plot_single_tet == 0:
        ...
        ax2.pcolormesh(time,np.arange(mean_X_right.shape[1]+1),norm_X_right.T,cmap='viridis',edgecolors='face')

        ax3.pcolormesh(time,np.arange(mean_X_left.shape[1]+1),norm_X_left.T,cmap='viridis',edgecolors='face')
